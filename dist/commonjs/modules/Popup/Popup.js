...
function (_Component) {
  ...
  function Popup() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "setPopupStyle", function () {
      var context = _this.getContext();

      if (!context || !_this.popupCoords) return;
      _this.coords = context.getBoundingClientRect();
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handlePortalMount", function (e) {
      ...
      if (hideOnScroll) {
        _lib.eventStack.sub('scroll', _this.hideOnScroll, {
          target: window
        });
      } else {
        _lib.eventStack.sub('resize', _this.setPopupStyle, {
          target: window
        });

        _lib.eventStack.sub('scroll', _this.setPopupStyle, {
          target: window
        });
      }
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "handlePortalUnmount", function (e) {
      ...
      if (hideOnScroll) {
        ...
        _lib.eventStack.unsub('resize', _this.setPopupStyle, {
          target: window
        });

        _lib.eventStack.unsub('scroll', _this.setPopupStyle, {
          target: window
        });
      }
