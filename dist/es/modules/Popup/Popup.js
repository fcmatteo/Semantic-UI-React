...
function (_Component) {
  ...
  function Popup() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePortalMount", function (e) {
      ...
      if (hideOnScroll) {
        eventStack.sub('scroll', _this.hideOnScroll, {
          target: window
        });
      } else {
        eventStack.sub('resize', _this.setPopupStyle, {
          target: window
        });
        eventStack.sub('scroll', _this.setPopupStyle, {
          target: window
        });
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePortalUnmount", function (e) {
      ...
      if (hideOnScroll) {
        ...
        eventStack.unsub('resize', _this.setPopupStyle, {
          target: window
        });
        eventStack.unsub('scroll', _this.setPopupStyle, {
          target: window
        });
      }
